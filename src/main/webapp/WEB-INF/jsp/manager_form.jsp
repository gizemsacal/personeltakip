...
<%@ page import="com.personeltakip.services.ManagerService" %>
...
<head>
    ...
    <title>Yönetici Ekle / Güncelle </title>
...
<body>
<div class="container">
    <spring:url value="/manager/addManager" var="addURL" /><br>
    <h2 align="center">Yönetici Ekle / Güncelle </h2><br>
    <form:form name="form" modelAttribute="managerForm" method="post" action="${addURL}" cssClass="form" >
